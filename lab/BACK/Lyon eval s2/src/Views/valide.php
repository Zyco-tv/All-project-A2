...
<body class="bg-gray-900 font-sans leading-normal tracking-normal ">
    <div class="flex flex-col md:flex-row">
            ...
            <div class=" md:w-48 md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    <li class="mr-3 flex-1">
                        <a href="/homedash" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-innocent-500">
                ...
                <div class="w-full md:w-full xl:w-full p-3">
                    ...
                    <!-- <div class="bg-white border-transparent rounded-lg shadow-lg">
                        ...
                        <div class="flex justify-end flex-wrap p-4">
                            <div>
                            <a href="" class="p-2 bg-gray-900 rounded hover:bg-gray-600 text-white">
      ...
      <h1 class="text-6xl  my-auto mx-auto  md:mx-48 ">
        Formulaire <br />
        <span class="text-red-400">Envoyé merci a toi bonne journée !</span>
      </h1>
                    <!--/Template Card-->
                </div>
            </div>
