    ...
    <div class="flex flex-col md:flex-row">
            ...
            <div class="md:mt-12 md:w-48 md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="/admin/dashboard" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-innocent-500">
        ...
        <div class="main-content flex-1 bg-gray-100 pb-24 md:pb-5">
            ...
            <div class="bg-gray-900 p-2 shadow text-xl text-white">
                <h3 class="font-bold pl-2">Message</h3>
            </div>
                ...
                <div class="w-full	md:w-full xl:w-full p-3">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-lg">
                        <div class="bg-gray-400 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg p-2">
                            <h5 class="font-bold uppercase text-gray-600">Candidature via le formulaire</h5>
                        </div>
                        <div class="p-5">
                            <h1>Nom: <?php echo $candidature->getName(); ?></h1>
                            <h1>Mail: <?php echo $candidature->getMail(); ?></h1>
                            <h1>Message: <?php echo $candidature->getMessage();?></h1>
                        </div>
                        <div class="flex justify-end flex-wrap p-4">
                            
                            <div class="ml-5">                            
                            <a href="/dashboard/admin/<?php echo $name;?>/delete" class="p-2 bg-gray-900 rounded hover:bg-gray-600 text-white">
