...
<body class="bg-gray-900 font-sans leading-normal tracking-normal">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-900 h-16 fixed bottom-0 md:relative md:h-screen z-10 w-full md:w-48">
            <div class="md:fixed">
            <div class="md:w-48 md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="/edite" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-innocent-500">
                            <i class="fas fa-chart-area pr-0 md:pr-3 text-gray-500"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Edition de la page</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="main-content flex-1 bg-gray-100 pb-24 md:pb-5">
            ...
            <div class="bg-gray-900 p-2 shadow text-xl text-white">
                <h3 class="font-bold pl-2">Liste des demande</h3>
            </div>
            ...
            <div class="flex flex-row flex-wrap flex-grow mt-2">
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-lg">
                        ...
                        <div class="p-5">
                            <h1>Nom: <?php echo $candidate->getName();?></h1>
                            <h1>Mail: <?php echo $candidate->getMail();?></h1>
                        </div>
                        <div class="flex justify-end flex-wrap p-4">
                            ...
                            <div class="ml-5">
                            <a href="/dashboard/admin/<?php echo $candidate->getName();?>" class="p-2 bg-gray-900 rounded hover:bg-gray-600 text-white">
